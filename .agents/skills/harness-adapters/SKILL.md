...
Muse, Gemini, and rovo are verified only for crewmate and scout work, never a secondmate or primary; AGY holds that boundary except as a main-session quota-handover source and destination in `bin/fm-primary-resource.sh`, fixture-grade only.
